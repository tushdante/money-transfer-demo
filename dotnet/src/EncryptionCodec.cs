...
{
    public const string DefaultKeyID = "test";
    public static readonly byte[] DefaultKey = System.Text.Encoding.ASCII.GetBytes("sa-rocks!sa-rocks!sa-rocks!yeah!");
    ...
    private byte[] Encrypt(byte[] data)
    {
        ...
        // a const-length tag
        // In real-world use, one may want to put nonce
