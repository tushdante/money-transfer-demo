...
public class AccountTransferWorkflowScenarios implements DynamicWorkflow {
    ...
    class AccountTransferDynamicListenerImpl implements AccountTransferMessages {
        ...
        @Override
        public TransferStatus getStateQuery() throws JsonProcessingException {
            return new TransferStatus(progressPercentage, transferState, "", chargeResult, approvalTime);
        }
